...
function updateScoreInURL(score) {
    const params = new URLSearchParams(window.location.search);
...
function updateGameOverInURL(isOver) {
    const params = new URLSearchParams(window.location.search);
    // Only set "true" or "false" explicitly so it's easy to parse:
    params.set("gameOver", isOver ? "true" : "false");
    const newURL = `${window.location.pathname}?${params.toString()}`;
    history.replaceState({}, '', newURL);
}
...
var Block = /** @class */ (function () {
    function Block(block) {
        ...
        // speed: scaling starts immediately (no 10-level delay)
...
var Game = /** @class */ (function () {
    function Game() {
        ...
        this.currentScore = getScoreFromURL(); // read initial score (display only)
        this.stage = new Stage();
        this.mainContainer = document.getElementById('container');
        this.scoreContainer = document.getElementById('score');
        this.startButton = document.getElementById('start-button');
        this.instructions = document.getElementById('instructions');
        this.scoreContainer.innerHTML = this.currentScore.toString();
        updateGameOverInURL(false); // mark not-over when initialized
    ...
    Game.prototype.restartGame = function () {
        ...
        TweenLite.to(countdown, cameraMoveSpeed, { value: 0, onUpdate: function () { _this.scoreContainer.innerHTML = String(Math.round(countdown.value)); updateScoreInURL(Math.round(countdown.value)); } });
    ...
    Game.prototype.addBlock = function () {
        ...
        this.currentScore = this.blocks.length - 1;
        this.scoreContainer.innerHTML = String(this.currentScore);
        updateScoreInURL(this.currentScore);
